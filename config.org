...
#+begin_src emacs-lisp
    (use-package general
      ...
      (start/leader-keys
        ...
        "r d" '(org-roam-dailies-goto-today :wk "dailies find today ")
...
Essential configuration for org-agenda to work with your org-roam files.
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
        (use-package org
          ...
          :config 
    	  (setq org-agenda-files '("d:/Prasad/roam/agenda.org"))
...
#+begin_src emacs-lisp
    ...
    (use-package ox-reveal
      :after org
      :config
      ;; Path to your local reveal.js installation
      ;; (setq org-reveal-root "file:///D:/Sandbox/reveal.js")
      ;; we will set this up in actual org file
      (setq org-reveal-root "https://cdn.jsdelivr.net/npm/reveal.js")
      
      ;; Optional: enable syntax highlighting in code blocks
      (setq org-html-htmlize-output-type 'css)
      (setq org-reveal-title-slide nil) ;; skip title slide if you want custom
    )
...
#+begin_src emacs-lisp
    ...
    (setq ispell-alternate-dictionary "d:/sofwares/hunspell/share/hunspell")
    (setenv "DICPATH" "d:/sofwares/hunspell/share/hunspell")
